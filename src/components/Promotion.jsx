...
export default function Promotion() {
	return (
		<div className="relative bg-gray-800 px-6 py-32 sm:px-12 sm:py-40 lg:px-16 lg:py-64">
			<div className="absolute inset-0 overflow-hidden bg-[url('../images/maggiewithducks.jpg')] bg-cover bg-top lg:bg-fixed"></div>
			<div
				aria-hidden="true"
